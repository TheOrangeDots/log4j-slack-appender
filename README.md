...
>When deploying your Servoy solution using WAR deployment, the SlackAppender.jar can be added to `application_server/lib` in teh Servoy Developer installation form where the WAR export is made.
>
